# reference: https://github.com/bullet-train-co/bullet_train-core/blob/main/bullet_train-obfuscates_id/app/models/concerns/obfuscates_id.rb
module ObfuscatesId
  ...
  module ClassMethods
    def hashids
      ...
      @hashids ||=
        Hashids.new "Default ID Obfuscation Salt for #{name}",
                    6,
